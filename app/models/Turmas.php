...
class Turmas
{
    public static function selectAll()
    {
        ...
        $sql = "SELECT * FROM sistemaEscolarNicollas.turmas";
        $sql = $con->prepare($sql);
        $sql->execute();
    ...
    public static function insert($dadosPost)
    {
        ...
        $con = Connection::getConn();
        $sql = $con->prepare("INSERT INTO sistemaEscolarNicollas.turmas (nome, professor) VALUES (:nomeDaTurma, :nomeProfessor)");
