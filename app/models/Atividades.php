...
class Atividades
{
    public static function selectByTurma($turma)
    {
        ...
        $sql = "SELECT * FROM sistemaEscolarNicollas.atividades where turma='$turma'";
        $sql = $con->prepare($sql);
        $sql->execute();
    ...
    public static function insert($dadosPost)
    {
        ...
        $con = Connection::getConn();
        $sql = $con->prepare("INSERT INTO sistemaEscolarNicollas.atividades (titulo, turma) VALUES (:tituloDaAtividade, :nomeDaTurma)");
    ...
    // {
    //     $con = Connection::getConn();
    //     $sql = $con->prepare("DELETE FROM sistemaEscolarNicollas.turmas WHERE nome='$turma'");
    //     $res = $sql->execute();
